...
def build_schema():
    ...
    return TEISchema(
        rules=[
            ...
            "Legal case example — '14 Including Smith v Jones, CA, 1998, FC3 98/1234; "
            "Brown v Crown, HL, 2001, A3/2000/5678; Black v White, CA, 2000.' → "
            "bibl span 1: text = '14 Including Smith v Jones, CA, 1998, FC3 98/1234;' "
            "with nested label span text = '14'; "
            "bibl span 2: text = 'Brown v Crown, HL, 2001, A3/2000/5678;' (no label); "
            "bibl span 3: text = 'Black v White, CA, 2000.' (no label).  "
            "ALL cited works need their own 'bibl' span.  After wrapping the first bibl, "
            ...
            "reader to it — e.g. 'See', 'Cf.', 'Including', 'In particular', 'Especially', "
            "'Nesse sentido:', 'For a contrary view, see', 'siehe auch', 'ver também' — "
            "belongs INSIDE that reference's 'bibl' span.  When such commentary introduces "
            "two or more consecutive references, attach it to the immediately following "
            "reference.  "
        ...
        elements=[
            TEIElement(
                ...
                description=(
                    ...
                    "name, title, publication, a legal case citation ('Party Name v Party Name, "
                    "Court, Date' or '[Year] Reporter Page'), or a short-form citation ('Ibid.', "
                    "'op. cit.', a bare page number following a prior citation).  An in-text mention of an "
